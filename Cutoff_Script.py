...
CohortDiagnosis AS (
    ...
    WHERE c.icd_name LIKE '%mild cognitive% impairment%'
       OR c.icd_name LIKE '%dementia%'
       OR c.icd_name LIKE '%alzheimer%'
...
SELECT
    ...
    COALESCE(la.lab_3003722_most_recent, 0) AS lab_3003722_recent, COALESCE(la.lab_3003722_mean_90d, 0) AS lab_3003722_mean, COALESCE(la.lab_3003722_median_90d, 0) AS lab_3003722_median, COALESCE(la.lab_3003722_abnormal_flag, 0) AS lab_3003722_abn,
    COALESCE(la.lab_3050174_most_recent, 0) AS lab_3050174_recent, COALESCE(la.lab_3050174_mean_90d, 0) AS lab_3050174_mean, COALESCE(la.lab_3050174_median_90d, 0) AS lab_3050174_median, COALESCE(la.lab_3050174_abnormal_flag, 0) AS lab_3050174_abn,
    COALESCE(la.lab_3043102_most_recent, 0) AS lab_3043102_recent, COALESCE(la.lab_3043102_mean_90d, 0) AS lab_3043102_mean, COALESCE(la.lab_3043102_median_90d, 0) AS lab_3043102_median, COALESCE(la.lab_3043102_abnormal_flag, 0) AS lab_3043102_abn,
    COALESCE(la.lab_42868556_most_recent, 0) AS lab_42868556_recent, COALESCE(la.lab_42868556_mean_90d, 0) AS lab_42868556_mean, COALESCE(la.lab_42868556_median_90d, 0) AS lab_42868556_median, COALESCE(la.lab_42868556_abnormal_flag, 0) AS lab_42868556_abn,
    COALESCE(la.lab_1469579_most_recent, 0) AS lab_1469579_recent, COALESCE(la.lab_1469579_mean_90d, 0) AS lab_1469579_mean, COALESCE(la.lab_1469579_median_90d, 0) AS lab_1469579_median, COALESCE(la.lab_1469579_abnormal_flag, 0) AS lab_1469579_abn,

    -- IDs: 1092155, 1259491, 3011498, 3029139, 3042151
    COALESCE(la.lab_1092155_most_recent, 0) AS lab_1092155_recent, COALESCE(la.lab_1092155_mean_90d, 0) AS lab_1092155_mean, COALESCE(la.lab_1092155_median_90d, 0) AS lab_1092155_median, COALESCE(la.lab_1092155_abnormal_flag, 0) AS lab_1092155_abn,
    COALESCE(la.lab_1259491_most_recent, 0) AS lab_1259491_recent, COALESCE(la.lab_1259491_mean_90d, 0) AS lab_1259491_mean, COALESCE(la.lab_1259491_median_90d, 0) AS lab_1259491_median, COALESCE(la.lab_1259491_abnormal_flag, 0) AS lab_1259491_abn,
    COALESCE(la.lab_3011498_most_recent, 0) AS lab_3011498_recent, COALESCE(la.lab_3011498_mean_90d, 0) AS lab_3011498_mean, COALESCE(la.lab_3011498_median_90d, 0) AS lab_3011498_median, COALESCE(la.lab_3011498_abnormal_flag, 0) AS lab_3011498_abn,
    COALESCE(la.lab_3029139_most_recent, 0) AS lab_3029139_recent, COALESCE(la.lab_3029139_mean_90d, 0) AS lab_3029139_mean, COALESCE(la.lab_3029139_median_90d, 0) AS lab_3029139_median, COALESCE(la.lab_3029139_abnormal_flag, 0) AS lab_3029139_abn,
    COALESCE(la.lab_3042151_most_recent, 0) AS lab_3042151_recent, COALESCE(la.lab_3042151_mean_90d, 0) AS lab_3042151_mean, COALESCE(la.lab_3042151_median_90d, 0) AS lab_3042151_median, COALESCE(la.lab_3042151_abnormal_flag, 0) AS lab_3042151_abn,

    -- IDs: 1761505, 1617650, 1616613, 3042810, 42868555, 1617024
    COALESCE(la.lab_1761505_most_recent, 0) AS lab_1761505_recent, COALESCE(la.lab_1761505_mean_90d, 0) AS lab_1761505_mean, COALESCE(la.lab_1761505_median_90d, 0) AS lab_1761505_median, COALESCE(la.lab_1761505_abnormal_flag, 0) AS lab_1761505_abn,
    COALESCE(la.lab_1617650_most_recent, 0) AS lab_1617650_recent, COALESCE(la.lab_1617650_mean_90d, 0) AS lab_1617650_mean, COALESCE(la.lab_1617650_median_90d, 0) AS lab_1617650_median, COALESCE(la.lab_1617650_abnormal_flag, 0) AS lab_1617650_abn,
    COALESCE(la.lab_1616613_most_recent, 0) AS lab_1616613_recent, COALESCE(la.lab_1616613_mean_90d, 0) AS lab_1616613_mean, COALESCE(la.lab_1616613_median_90d, 0) AS lab_1616613_median, COALESCE(la.lab_1616613_abnormal_flag, 0) AS lab_1616613_abn,
    COALESCE(la.lab_3042810_most_recent, 0) AS lab_3042810_recent, COALESCE(la.lab_3042810_mean_90d, 0) AS lab_3042810_mean, COALESCE(la.lab_3042810_median_90d, 0) AS lab_3042810_median, COALESCE(la.lab_3042810_abnormal_flag, 0) AS lab_3042810_abn,
    COALESCE(la.lab_42868555_most_recent, 0) AS lab_42868555_recent, COALESCE(la.lab_42868555_mean_90d, 0) AS lab_42868555_mean, COALESCE(la.lab_42868555_median_90d, 0) AS lab_42868555_median, COALESCE(la.lab_42868555_abnormal_flag, 0) AS lab_42868555_abn,
    COALESCE(la.lab_1617024_most_recent, 0) AS lab_1617024_recent, COALESCE(la.lab_1617024_mean_90d, 0) AS lab_1617024_mean, COALESCE(la.lab_1617024_median_90d, 0) AS lab_1617024_median, COALESCE(la.lab_1617024_abnormal_flag, 0) AS lab_1617024_abn,

    -- ==========================================================
    -- 4. PROCEDURE METRICS (180d Count & 90d Presence Flag)
    -- ==========================================================
    -- IDs: 2211329, 2211328, 2211327, 2211332, 2211330
    COALESCE(pr.procedure_count_180d_2211329, 0) AS pr_2211329_ct, COALESCE(pr.procedure_within_90d_2211329, 0) AS pr_2211329_90d,
    COALESCE(pr.procedure_count_180d_2211328, 0) AS pr_2211328_ct, COALESCE(pr.procedure_within_90d_2211328, 0) AS pr_2211328_90d,
    COALESCE(pr.procedure_count_180d_2211327, 0) AS pr_2211327_ct, COALESCE(pr.procedure_within_90d_2211327, 0) AS pr_2211327_90d,
    COALESCE(pr.procedure_count_180d_2211332, 0) AS pr_2211332_ct, COALESCE(pr.procedure_within_90d_2211332, 0) AS pr_2211332_90d,
    COALESCE(pr.procedure_count_180d_2211330, 0) AS pr_2211330_ct, COALESCE(pr.procedure_within_90d_2211330, 0) AS pr_2211330_90d,

    -- IDs: 2211353, 2211351, 2211719, 2212018, 2212056, 2212053
    COALESCE(pr.procedure_count_180d_2211353, 0) AS pr_2211353_ct, COALESCE(pr.procedure_within_90d_2211353, 0) AS pr_2211353_90d,
    COALESCE(pr.procedure_count_180d_2211351, 0) AS pr_2211351_ct, COALESCE(pr.procedure_within_90d_2211351, 0) AS pr_2211351_90d,
    COALESCE(pr.procedure_count_180d_2211719, 0) AS pr_2211719_ct, COALESCE(pr.procedure_within_90d_2211719, 0) AS pr_2211719_90d,
